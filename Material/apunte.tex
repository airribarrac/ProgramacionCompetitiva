...
\end{titlepage}	
	...
	\section{Fenwick Tree}\index{RSQ}
	...
	\section{Segment Tree}\index{RMQ}
	...
	\section{Sparse Table}\index{RSQ}\index{RMQ}\index{Sub-Array}
		\lstinputlisting{Estructuras/sparsetable.cpp}
			
	\section{Wavelet Tree}
	\index{Kth smallest}\index{Sub-Array}
		\lstinputlisting{Estructuras/wavelet.cpp}
		\section{Interval Tree}
		\lstinputlisting{Estructuras/intervaltree.cpp}
		\section{Merge Sort Tree}
		\lstinputlisting{Estructuras/mergesorttree.cpp}
	...
	\section{Algoritmo de Gausss}\index{Sistemas de ecuaciones}
...
\section{Dinic}
	...
	\section{0/1 Knapsack}\index{Knapsack}
	\lstinputlisting{DP/01knap.cpp}l
	\section{Longest Common Subsequence}\index{LCS}
	...
	\section{Catalan}\index{Catalan Numbers}
